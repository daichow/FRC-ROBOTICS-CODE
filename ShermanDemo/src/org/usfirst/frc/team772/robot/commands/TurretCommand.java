...
public class TurretCommand extends Command {
    ...
    protected void initialize() {
    	setTimeout(timeout);
    	SmartDashboard.putString("DB/String 1", "init TO: " + timeout);
    	if(mode == Mode.Auto){ // Auto
    		Robot.turretSubsystem.disable();
    		if (setpoint == 20000) {
    			Robot.turretSubsystem.setSetpoint(RobotMap.encToX);
    			SmartDashboard.putString("DB/String 2", "Track: " + RobotMap.encToX);
    		} else {
    ...
    protected void execute() {
    	SmartDashboard.putString("DB/String 3", "Going");
    }
    ...
    protected boolean isFinished() {
    	...
    	if(mode == Mode.Auto){ // Auto
    		if (timeout == 0) {
    			...
    			SmartDashboard.putString("DB/String 4", "Checking");
