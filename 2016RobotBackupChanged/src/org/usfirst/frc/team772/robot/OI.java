...
public class OI {
	...
	public OI() {		
		j1button1.whenPressed(new FeedPickUpCommand()); // auto pickup rumble when in
		...
		j1button4.whenPressed(new BallInTeleRumbleCommand()); // ball in rumble when in
...
//		j2button1.whenPressed(new ShootingCommand()); // aim shoot
		j2button1.whenPressed(new JustShootCommand());
		...
		j3button1.whenPressed(new RotateCommand(0, false));
		j3button2.whenPressed(new RotateCommand(180, false));
