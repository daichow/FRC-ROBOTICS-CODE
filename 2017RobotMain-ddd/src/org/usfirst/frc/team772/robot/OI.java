...
public class OI {
	...
	public OI(){
		...
		j1button5.whileHeld(new VisionLidarShootCommand());//positive was 83
		j1button6.whileHeld(new LidarShootCommand());
		j1button7.whileHeld(new ShootCommand(true, .805));//positive
...
//		j2button3.whileHeld(new VisionGearTargetCommand("targets"));
		j2button4.whileHeld(new LidarShootCommand());
		...
		j2button8.whileHeld(new AgitatorCommand());
