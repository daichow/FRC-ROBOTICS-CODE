...
public class Robot extends IterativeRobot {
    ...
    AxisCamera camera;
    Image image;
    ImageType imageType = ImageType.IMAGE_HSL;
    MoleyVision vision = new MoleyVision();
...
//        chooser.addObject("My Auto", new MyAutoCommand());
    ...
    public void teleopInit() {
    	...
    	image = NIVision.imaqCreateImage(imageType, 7);
    	System.out.println(MoleyVision.IVA_CLRThreshold(image, 0, 255, 0, 255, 242, 255, ColorMode.HSL));
