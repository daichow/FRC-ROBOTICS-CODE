...
public class Robot extends IterativeRobot {
	...
	public static OI oi;
//	public String asd = lidarSubsystem.lidarDistance();
//	public double dsa = lidarSubsystem.lidarDistance();
...
SmartDashboard.putString("DB/String 0","Lidar: " + lidarSubsystem.asd());
		Scheduler.getInstance().run();
	}
