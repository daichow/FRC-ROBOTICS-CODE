...
public class Vision {	
	...
	NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(88, 174);	//Default hue range for yellow tote 100, 255
	NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(12, 229);	//Default saturation range for yellow tote 50, 255
	NIVision.Range TOTE_LUM_RANGE = new NIVision.Range(188, 255);	//Default value range for yellow tote 100, 255
