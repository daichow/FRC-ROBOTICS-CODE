...
public class OI {
	...
	public OI(){
		j1button1.whileHeld(new IntakeCommand(3));
		j1button2.whileHeld(new IntakeCommand(2));
		j1button5.whileHeld(new TipperCommand(true));
		j1button6.whileHeld(new TipperCommand(false));
		
		j2button1.whenPressed(new ShooterCommand());
		j2button5.whileHeld(new TurretCommand(true));//right
		j2button6.whileHeld(new TurretCommand(false));//left
		j2button7.whenPressed(new FlywheelCommand(1));
		j2button8.whenPressed(new TurretFixCommand(0));
	}
