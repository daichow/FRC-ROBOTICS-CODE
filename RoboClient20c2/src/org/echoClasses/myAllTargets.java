...
//	}
 public static void printSingleTargetInfo(Target atarget) {
	...
	public static void printTargetInfo(ArrayList<Target> currentTargets, int x ) {
		...
		double ca = currentTargets.get(x).getContourArea();
		double ra = currentTargets.get(x).getRectArea();
		double ar = currentTargets.get(x).getAspectRatio();
		double offset = currentTargets.get(x).getDegreeOffset();
		double extent = currentTargets.get(x).getExtentRatio();
		double solidity = currentTargets.get(x).getSolidity();
		
		
		System.out.println("centreX : " + centreX);
		System.out.println("centreY : " + centreY);
		System.out.println("ContourArea : " + ca);
		System.out.println("Rectangle Area : " + ra);
		System.out.println("Extent Ratio : " + extent);
		System.out.println("Solidity Ratio : " + solidity);
