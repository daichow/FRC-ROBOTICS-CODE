...
//        	 SmartDashboard.putString("DB/String 0", ""+ centerX[0]);
//        	 SmartDashboard.putString("DB/String 1", ""+ centerY[0]);
        SmartDashboard.putString("DB/String 0", ""+sortArea());
        
//        SmartDashboard.putString("DB/String 0", ""+ network.getNumberArray("area", defaultValue));
    ...
    public  double sortArea(){
    	double[] defaultValue = new double[0];
        double[] area = network.getNumberArray("area", defaultValue);
        int a = area.length;
        System.out.print(a);
//        double[] reverse =  new double[area.length];
//        for(int i = 0; i < reverse.length; i++){
//        	reverse[i] = area[((area.length - i)+1)];
//        }
