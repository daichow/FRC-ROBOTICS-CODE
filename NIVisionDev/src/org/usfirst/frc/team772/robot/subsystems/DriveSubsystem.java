...
public class DriveSubsystem extends Subsystem {
	...
	CANTalon driveMotor1 = new CANTalon(RobotMap.frontleftmotor);
	CANTalon driveMotor2 = new CANTalon(RobotMap.rearleftmotor);
	CANTalon driveMotor3 = new CANTalon(RobotMap.frontrightmotor);
	CANTalon driveMotor4 = new CANTalon(RobotMap.rearrightmotor);
...
//    public int getEnc(){
//    	return driveMotor4.getEncPosition();
//    }
