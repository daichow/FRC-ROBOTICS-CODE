...
//		}
    ...
    public void printPeriodic() {
    	...
    	if (RobotMap.timeFlyOn != 0) {
    		setDash(4, "FlyTime: " + (System.currentTimeMillis() - RobotMap.timeFlyOn) / 1000); // flywheel ramp up time seconds
    	} else {
...
//    	setDash(7, "Time Left: " + round(this.m_ds.getMatchTime(), 2));
    ...
    public void ntPeriodic(){
    	RobotMap.centerX = cameraValues.getNumber("T1_Centerx", 0) - 320 + 40; // reads network table value for centerX and offsets
