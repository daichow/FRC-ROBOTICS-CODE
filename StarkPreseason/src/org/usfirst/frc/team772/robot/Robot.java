...
import org.usfirst.frc.team772.robot.subsystems.ConveyerSubsystem;
...
public class Robot extends IterativeRobot {
	...
	public static final DriveCommand drive = new DriveCommand("Manual", 1);
	public static final FlywheelSubsystem flywheelSubsystem = new FlywheelSubsystem();
	public static final IntakeSubsystem intakesubsystem = new IntakeSubsystem();
	public static final ConveyerSubsystem conveyerSubsystem = new ConveyerSubsystem();
...
//        chooser.addObject("My Auto", new MyAutoCommand());
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putString("DB/String 1", "" + driveSubsystem.encoder());
    }
