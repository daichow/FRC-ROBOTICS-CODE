...
public class DriveSubsystem extends Subsystem {
	...
	CANTalon driveMotor1 = new CANTalon(1); // creates drive motor 1
	CANTalon driveMotor2 = new CANTalon(2); // creates drive motor 2
	CANTalon driveMotor3 = new CANTalon(3); // creates drive motor 3
	CANTalon driveMotor4 = new CANTalon(4); // creates drive motor 4
