...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		Scheduler.getInstance().run();
		lidarSubsystem.update();
		lidarSubsystem.read();
		SmartDashboard.putString("DB/String 1", "Lidar: "+lidarSubsystem.getDistance());
		SmartDashboard.putString("DB/String 2", "Lidar: "+lidarSubsystem.asd());
	}
