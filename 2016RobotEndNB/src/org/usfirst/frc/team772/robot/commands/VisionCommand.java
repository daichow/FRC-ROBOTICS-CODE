...
public class VisionCommand extends Command {
	...
	// 212, 255
	// 128, 243
	NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(0, 52);	//Default hue range for yellow tote 100, 255
	NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(196, 255);	//Default saturation range for yellow tote 50, 255
	NIVision.Range TOTE_LUM_RANGE = new NIVision.Range(96, 199);	//Default value range for yellow tote 100, 255
    ...
    protected void execute() {
		try{
			// thresholds by colour
	   		NIVision.imaqColorThreshold(Robot.binaryFrame, Robot.frame, 255, NIVision.ColorMode.HSI, TOTE_HUE_RANGE, TOTE_SAT_RANGE, TOTE_LUM_RANGE);
