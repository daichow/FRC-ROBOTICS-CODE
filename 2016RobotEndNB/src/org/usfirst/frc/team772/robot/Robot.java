...
//	public static final NavxSubsystem navxSubsystem = new NavxSubsystem();
	...
	public static Counter encoderCounter = new Counter();
...
//    	navxSubsystem.reset();
        ...
        lidarSubsystem.start();
       	...
       	encoderCounter.setUpSource(4);
       	encoderCounter.setSamplesToAverage(10);
       	encoderCounter.setUpdateWhenEmpty(true);
...
//    	setDash(4, "DistanceUS: " + round(ultrasonicSubsystem.getDistanceUS(), 3));
    	setDash(4, "FlyRate: " +  round(1 / encoderCounter.getPeriod(), 3));
